...
4. **Last known state** — if the project keeps session notes or a resume checkpoint (e.g. a `session_state_*.md` or `compact_checkpoint.md` in a memory/notes folder), read it for what the user was last doing here.
